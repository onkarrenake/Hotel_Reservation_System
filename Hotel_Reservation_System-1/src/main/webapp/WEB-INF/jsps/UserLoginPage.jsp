...
<title>Well Come To Login Page</title>
<style>
...
<br><br><br><br><h2 align = "center">Visitor Login</h2><hr><br><br>
	<form action = "loginUser" method = "post">
		<table align = "center">
		<tr>
		<td>User Name : </td><td><input type = "text" name = "email" placeholder = "example@gmail.com"></td>
		</tr>
		<tr>
