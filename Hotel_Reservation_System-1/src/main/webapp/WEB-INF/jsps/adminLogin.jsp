...
<title>Well Come To Admin Login Page</title>
<style>
...
<br><br><br><br><h2 align = "center">Admin Login</h2><hr><br><br>
	<form action = "loginAdmin" method = "post" >
		<table align = "center">
		<tr>
		<td>Admin Name : </td><td><input type = "text" name = "email" placeholder = "example@gmail.com"></td>
		</tr>
		<tr>
		...
		<tr>
		<td><a href = "userRegistration"><i>Register link</i></a></td>
		</tr>
		<tr>
		<td>${msg }</td>
		</tr>
